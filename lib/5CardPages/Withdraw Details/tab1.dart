...
class WithdrawTab1 extends StatefulWidget {
  final String user;
  const WithdrawTab1({super.key, required this.user});
  @override
...
class _InvestmentdetailsState extends State<WithdrawTab1> {
              ...
              return Column(
                children: [
                  Padding(
                    ...
                    child: Text(
                      'Total Withdraw:   ${numberFormat.format(totallInvestment)}/- ',
  ...
  Future<List<Map<String, dynamic>>> getData() async {
    ...
    final querySnapshot = await collectionRef
        ...
        .where('Withdraw Approved', isEqualTo: true)
        .get();
