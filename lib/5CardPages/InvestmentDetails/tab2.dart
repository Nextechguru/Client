...
class InvestmentTab2 extends StatefulWidget {
  final String user;
  const InvestmentTab2({super.key, required this.user});
  @override
...
class _InvestmentTabState extends State<InvestmentTab2> {
          ...
          child: FutureBuilder<List<Map<String, dynamic>>>(
            ...
            builder: (context, snapshot) {
              ...
              totallInvestment = data.fold(
                  0.0, (sums, item) => sums + (item['Invest Amount'] as num));
  ...
  Future<List<Map<String, dynamic>>> getData() async {
    ...
    final querySnapshot = await collectionRef
        ...
        .where('Investment Approved', isEqualTo: false)
        .get();
